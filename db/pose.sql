...
CREATE TABLE `algorithm` (
                             ...
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='算法表';
...
CREATE TABLE `developer_review` (
                                    ...
                                    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                                    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='开发者审核表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `resources` (
                             ...
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='资源表元数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `session` VALUES ('cc425bc8-23e4-4716-97b6-a3e22c10ef7c',13,'192.168.0.105','2023-08-26 12:03:44'),('da0f72fc-8042-40cb-8b51-8077e881048c',1,'192.168.0.105','2023-08-26 12:28:38'),('38312c85-63be-4821-8834-aea1b9932d37',1,'192.168.0.104','2023-08-29 20:26:29'),('4788220e-41a6-45cc-aea1-76c95abb0d4a',1,'192.168.0.100','2023-08-29 21:50:31'),('06136cf9-d0a9-49f2-ac5c-10eeee0efe12',13,'192.168.0.100','2023-08-29 21:53:40'),('9a36678a-34e8-42eb-8a2b-9b804d4a271d',13,'192.168.0.104','2023-08-29 22:15:56'),('b9a57fe1-484f-417f-8e16-85e6bf461028',13,'169.254.35.13','2023-08-29 23:51:50');
...
-- Dump completed on 2023-08-29 23:53:24
