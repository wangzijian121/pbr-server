...
VALUES (1, '足球射门姿势算法', 0, 1, 1, 1, 1, 'ea', '文档', '这是一个案例', '2023-08-14 17:47:57'),
       ...
       (20, '跳远距离识别', 1, 9, 1, 0, 1, 'ae93811f-3fe9-41ab-8163-279151440323', '1234', '1234',
        '2023-08-30 23:32:30');
...
VALUES (1, 1, 0, 1, 1, '备注', '2023-08-14 08:19:49'),
       ...
       (28, 3, 0, 14, 1, '234567890', '2023-08-14 09:03:32'),
       (29, 16, 0, 20, 1, NULL, '2023-08-31 00:09:19'),
       (30, 2, 0, 3, 1, '123', '2023-09-05 21:38:40'),
       (31, 2, 0, 10, 1, '备注', '2023-09-05 21:41:54');
...
VALUES (1, 0, 2, '2023-07-28 09:27:06', 1, '2023-07-28 09:27:06', 0, '备注', '2023-07-28 09:27:06'),
       (6, 1, 2, '2023-08-14 08:45:09', 1, '2023-08-14 08:45:09', 0, '1222', '2023-08-14 08:45:04'),
       (7, 0, 17, '2023-08-30 23:35:02', 1, '2023-08-30 23:35:02', 1, '123', '2023-08-30 23:34:45'),
...
VALUES (24, 42, 999, 1, '支付宝10086', '2023-08-26 04:21:56'),
       (26, 48, 9999, 1, '已付款到支付宝10086', '2023-08-26 04:56:43');
...
VALUES (1, '足球数据集', 1, 1, '73863c41-b494-48e5-841e-815b8ba701b3', 'demo', 1, 1, '2023-08-13 23:57:51'),
       (5, '篮球投篮动作数据集', 0, 7, '3d5a1466-51dc-4da7-ab9f-01eaae60a568', '123', 0, 1, '2023-08-14 07:00:10'),
       (6, '跳远数据集', 1, 4, '5059b39d-73d1-4d06-bda3-0b3baca547df', '123', 0, 1, '2023-08-30 23:31:21');
...
VALUES (24, '羽毛球羽翼飞行结构数据集', '羽毛球', 13, 3, '1fa01764-82ec-42ed-b1bb-1a72604bae3f', '文档', '这是一个案例',
       ...
       (49, '乒乓球挥拍数据集', '乒乓球', 13, 3, 'dad4a009-2e9b-4797-8079-07339eddfe62', 'docs', 'demo',
        ...
        '2023-08-26 04:54:15'),
       (50, '游泳算法', '游泳', 13, 1, 'dd9441e3-8eec-4252-a28a-05e93273b5d2', '算法文档1', '算法样例2', NULL, 1,
        '2023-08-26 05:15:33'),
       (51, '新游泳算法', '游泳', 13, 0, 'f0751326-1a51-40fe-a759-2c3cb6247221', '算法文档\n', '算法样例\n', NULL, 1,
        '2023-08-26 05:20:35'),
       (52, '1234', '体育', 13, 0, '123', '123', '1234', '123', 1, '2023-08-28 14:24:52'),
       (53, '王子健测试的算法', '走路', 13, 0, '6e2eefb3-fc25-4baf-83c3-fad4a432e9fe', '123', '123',
        '{\"id\":53,\"createTime\":\"2023-08-29T16:43:12.013Z\",\"status\":3,\"mark\":\"123\"}', 3,
        '2023-08-30 00:42:37');
...
(
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='机构表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, '乐刻健身', 2, '10086', '123@qq.com', 'beijing',
        ...
        '2023-07-27 13:50:06'),
       (2, '润迪2', 1, '10085', '123456@qq.com', '中国',
        'https://map.baidu.com/poi/%E5%93%88%E5%B0%94%E6%BB%A8%E4%BD%93%E8%82%B2%E5%AD%A6%E9%99%A2/@14102582.756673405,5712157.242628686,17.38z?uid=2fff5b7869fe25d72b3a9f13&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl',
        '2023-07-25 22:09:53'),
       (3, 'XT体育', 1, '10085', '123456@qq.com', '中国',
        'https://map.baidu.com/poi/%E5%93%88%E5%B0%94%E6%BB%A8%E4%BD%93%E8%82%B2%E5%AD%A6%E9%99%A2/@14102582.756673405,5712157.242628686,17.38z?uid=2fff5b7869fe25d72b3a9f13&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl',
        '2023-08-08 22:09:53'),
       (16, '哈尔滨体育俱乐部', 0, '10086', '1219116968@qq.com',
        ...
        NULL),
       (17, '子健云123', 0, '18846922264', '1219116968@qq.com', '北京市',
        'https://map.baidu.com/poi/%E6%8C%91%E6%88%98%E8%80%85%E5%B0%84%E5%87%BB%E4%BF%B1%E4%B9%90%E9%83%A8/@14083751.53,5730661.98,12z?uid=723286a1924ee2143c9a5e8f&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl',
        '2023-08-30 23:43:21');
...
VALUES (19, '特征识别平台.zip', '4b4901b8-7af4-444a-b044-3067902cfaf2', 'zip', 4975585, '2023-08-04 00:24:21',
       ...
       (72, '课程表格.zip', '73863c41-b494-48e5-841e-815b8ba701b3', 'zip', 34136, '2023-08-12 22:50:45',
        '2023-08-12 22:50:45'),
       ...
       (95, '课程表格.zip', '42affae1-e309-4628-93dd-30bf58af94e1', 'zip', 34136, '2023-08-13 16:47:06',
        '2023-08-13 16:47:06'),
       (96, '特征识别平台.zip', 'a66bd977-82c5-4d3b-9a97-f3aa7c5f24a7', 'zip', 4975585, '2023-08-13 18:32:36',
        '2023-08-13 18:32:36'),
       ...
       (98, 'DG5501488_x64.ZIP', '52d5c73d-1c0f-4e2b-9956-6ac09345ece5', 'ZIP', 39449361, '2023-08-13 22:52:56',
        '2023-08-13 22:52:56'),
       (102, '特征识别平台.zip', '3d5a1466-51dc-4da7-ab9f-01eaae60a568', 'zip', 4975585, '2023-08-13 23:00:45',
        '2023-08-13 23:00:45'),
       (104, '测试算法文件.zip', 'a45af1c1-a66a-4a80-b3e7-2ae6c743907f', 'zip', 4975585, '2023-08-14 09:53:48',
        '2023-08-14 09:53:48'),
       ...
       (145, '2022_s12.zip', 'd1b4693e-dcef-4f13-9119-d901522cde9e', 'zip', 2539566, '2023-08-28 22:14:12',
        '2023-08-28 22:14:12'),
       (146, '2022_s12.zip', '642df7e3-1318-4457-b621-a08657a81b75', 'zip', 2539566, '2023-08-28 22:15:34',
        '2023-08-28 22:15:34'),
       ...
       (150, '算法文件.zip', '6e9553f0-2c04-44f0-b8a2-db77e4678c6f', 'zip', 22, '2023-08-30 21:46:51',
        '2023-08-30 21:46:51'),
       (151, '算法文件.zip', 'ae93811f-3fe9-41ab-8163-279151440323', 'zip', 22, '2023-08-30 23:30:20',
        '2023-08-30 23:30:20'),
...
INSERT INTO `session`
VALUES ('8d88dc18-99e4-45b1-b871-e50f929ae54e', 1, '192.168.0.100', '2023-08-31 20:28:10'),
       ('f65fea20-5087-4b1e-974f-6644871a5401', 1, '192.168.0.104', '2023-08-31 20:56:33'),
       ('82d8532c-a082-4b7c-971f-0543c39f6ad5', 13, '192.168.0.104', '2023-08-31 20:56:44'),
       ('78c93c64-f617-4de4-a834-926fe185d850', 1, '127.0.0.1', '2023-09-05 14:46:33');
...
VALUES (1, '0', '田径', 1, '备注', '2023-08-14 17:47:35'),
       ...
       (5, '0', '立定跳远', 1, '备注', '2023-07-26 13:47:32'),
...
VALUES (1, '通用模板', '{
  \"distance\": \"number\", \"player_name\": \"string\", \"follow_through\": \"string\"}', '2023-08-14 17:49:52',
        '修改后备注'),
       (2, '篮球类模板', '{
         \"distance\": \"number\", \"player_name\": \"string\", \"follow_through\": \"string\"}', '2023-08-14 17:50:06',
        '备注'),
       (3, '足球类模板', '{
         \"distance\": \"number\", \"player_name\": \"string\", \"follow_through\": \"string\"}', '2023-08-14 17:50:16',
        '1211111'),
       (4, '乒乓球类模板', '{
         \"distance\": \"number\", \"player_name\": \"string\", \"follow_through\": \"string\"}', '2023-08-14 17:51:05',
        NULL),
       (5, '模板名', '{
         \"distance\": \"number\", \"player_name\": \"string\", \"follow_through\": \"string\"}', '2023-08-26 19:33:31',
        '123');
...
VALUES (1, 0, '王子健', 'root',
       ...
       (12, 1, '程序员小王12', 'wangzijian',
        ...
        '支付宝：10086', '2023-08-26 04:22:48', '{
         \"phone\": \"18846922264\"}'),
       (13, 1, '程序员小王13', 'wangzijian13',
        '$argon2id$v=19$m=65536,t=2,p=1$qLOynwPpnMNMD9rvPUYdSw$sJwlQGaHl3brLdzvy7mzIxw+6PgGHg2fO1L4cKQXkl8',
        '支付宝：10086', '2023-08-26 04:23:05', '{
         \"phone\": \"10086\"}'),
       (14, 0, 'admin', 'admin',
        '$argon2id$v=19$m=65536,t=2,p=1$azoAkY126sM6d8rkKX+7OA$CXq1B2tm27jC3tkzAVbJKk3yunK9aOti+gE2WzLgin0', NULL,
        '2023-08-31 00:05:19', NULL),
       (15, 3, '学生小王', '18846922264', NULL, NULL, NULL, '{
         \"login_count\": 5, \"lastLogintime\": \"2023-09-05 00:05:00\"}');
...
VALUES (1, '1289371982739123', '润迪体育助手', 1, 0, '润迪开通的小助手', '2023-07-28 09:49:59'),
       ...
       (4, 'wxc62afc144417346e', '润迪专属小程序', 2, 1, NULL, '2023-08-14 07:34:45');
...
VALUES (1, '1', 8, 800, 20, '{
  \"篮球\": 4, \"足球\": 16}', NULL),
       (12, 'wxc62afc144417346e', 1, 1, 1, '123', '2023-09-05 23:25:29');
...
-- Dump completed on 2023-09-06 19:33:46
