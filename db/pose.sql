...
--
-- Host: wangzijian.top    Database: pose-management-rel
-- ------------------------------------------------------
...
CREATE TABLE `algorithm` (
                             ...
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='算法表';
...
INSERT INTO `algorithm` VALUES (1,'足球射门姿势算法',0,14,1,1,1,'ea','文档','这是一个案例','https://wangzijian.top/score','2023-08-14 17:47:57'),(3,'游泳姿势优化算法',1,8,1,1,1,'ea','文档','这是一个案例','https://wangzijian.top/score','2023-08-14 17:45:11'),(10,'田径起跑姿势优化算法',1,1,2,2,1,'e1a1f62d-85a4-4a96-8af5-0440d41e0abd','文档','样例','https://wangzijian.top/score','2023-08-14 17:47:20'),(14,'足球专用犯规识别算法',0,14,1,0,1,NULL,'文档','文档demo','https://wangzijian.top/score','2023-08-14 02:27:31'),(15,'篮球手部识别算法',1,7,1,0,1,'a66bd977-82c5-4d3b-9a97-f3aa7c5f24a7','文档','样例demo','https://wangzijian.top/score','2023-08-14 02:32:31'),(16,'乒乓球角度识别算法',1,11,4,0,12,'a45af1c1-a66a-4a80-b3e7-2ae6c743907f','文档','demo','https://wangzijian.top/score1','2023-09-24 20:42:18'),(17,'新建铅球算法',0,2,1,0,1,'642df7e3-1318-4457-b621-a08657a81b75','123','456','https://wangzijian.top/score','2023-08-28 22:15:06'),(20,'跳远距离识别',1,5,1,0,1,'ae93811f-3fe9-41ab-8163-279151440323','1234','1234','https://wangzijian.top/score','2023-08-30 23:32:30'),(21,'标枪弧度算法',0,21,1,1,1,'f36b39e3-30ac-45ab-a237-6a338c06eddd','标枪弧度算法','标枪弧度算法','https://wangzijian.top/score','2023-09-21 15:54:06'),(22,'标枪算法',0,21,1,1,1,'b7aab323-9de8-4a36-a513-a35da6ace54a','如何使用','./bin/start.sh','https://wangzijian.top/score','2023-09-22 22:31:23'),(24,'高尔夫球道算法',0,22,1,1,1,'5cd238fb-5b5f-4ff3-9a6b-56e0ac1c2288','算法文档','demo','https://wangzijian.top/score','2023-09-25 01:26:11');
...
CREATE TABLE `auth_institution_alg` (
                                        ...
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='授权机构算法表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `charge` (
                          ...
                          PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='付费表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `charge` VALUES (7,0,17,'2023-08-30 23:35:02',1,'2023-08-30 23:35:02',1,'123','2023-08-30 23:34:45'),(8,0,17,'2023-08-30 23:35:29',1,'2023-08-30 23:35:29',1,NULL,'2023-08-30 23:35:16'),(9,5,2,'2023-09-22 22:40:10',1,'2023-09-22 22:40:10',1,NULL,'2023-09-22 22:39:58'),(10,5,200,'2023-09-24 21:14:50',1,'2023-09-24 21:14:50',1,NULL,'2023-09-24 21:14:38'),(11,5,201,'2023-09-25 01:29:57',1,'2023-09-25 01:29:57',1,NULL,'2023-09-25 01:29:46');
...
CREATE TABLE `commission` (
                              ...
                              PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='佣金发放表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `commission` VALUES (24,42,999,1,'支付宝10086','2023-08-26 04:21:56'),(26,48,9999,1,'已付款到支付宝10086','2023-08-26 04:56:43'),(27,54,666,1,'','2023-09-22 22:30:55'),(28,58,999,1,'','2023-09-25 01:23:17');
...
CREATE TABLE `data_set` (
                            ...
                            `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                            PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='数据集表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `data_set` VALUES (1,'足球数据集',1,1,'73863c41-b494-48e5-841e-815b8ba701b3','demo',1,1,'2023-08-13 23:57:51'),(5,'篮球投篮动作数据集',0,7,'3d5a1466-51dc-4da7-ab9f-01eaae60a568','123',0,1,'2023-08-14 07:00:10'),(6,'跳远数据集',1,5,'5059b39d-73d1-4d06-bda3-0b3baca547df','123',0,1,'2023-09-23 18:15:45'),(7,'乒乓球数据集',0,11,'4b5585c6-b122-4165-928f-b9c87f37c444','乒乓球数据集',0,1,'2023-09-21 15:52:35');
...
CREATE TABLE `developer_review` (
                                    ...
                                    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                                    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='开发者审核表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `institution` (
                               ...
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=202 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='机构表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `institution` VALUES (1,'乐刻健身',2,'10086','123@qq.com','beijing','https://map.baidu.com/poi/%E5%93%88%E5%B0%94%E6%BB%A8%E4%BD%93%E8%82%B2%E5%AD%A6%E9%99%A2/@14102582.756673405,5712157.242628686,17.38z?uid=2fff5b7869fe25d72b3a9f13&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl','2023-07-27 13:50:06'),(2,'润迪',1,'18846922264','123456@qq.com','中国','https://map.baidu.com/poi/%E5%93%88%E5%B0%94%E6%BB%A8%E4%BD%93%E8%82%B2%E5%AD%A6%E9%99%A2/@14102582.756673405,5712157.242628686,17.38z?uid=2fff5b7869fe25d72b3a9f13&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl','2023-09-22 22:32:10'),(3,'XT体育',1,'10085','123456@qq.com','中国','https://map.baidu.com/poi/%E5%93%88%E5%B0%94%E6%BB%A8%E4%BD%93%E8%82%B2%E5%AD%A6%E9%99%A2/@14102582.756673405,5712157.242628686,17.38z?uid=2fff5b7869fe25d72b3a9f13&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl','2023-08-08 22:09:53'),(17,'子健云123',0,'18846922264','1219116968@qq.com','北京市','https://map.baidu.com/poi/%E6%8C%91%E6%88%98%E8%80%85%E5%B0%84%E5%87%BB%E4%BF%B1%E4%B9%90%E9%83%A8/@14083751.53,5730661.98,12z?uid=723286a1924ee2143c9a5e8f&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl','2023-08-30 23:43:21'),(198,'哈尔滨体育俱乐部',0,'10086','1219116968@qq.com','黑龙江省哈尔滨市呼兰区利民西六大街学院路950号哈尔滨信息工程学院东侧','https://map.baidu.com/poi/%E6%8C%91%E6%88%98%E8%80%85%E5%B0%84%E5%87%BB%E4%BF%B1%E4%B9%90%E9%83%A8/@14083751.53,5730661.98,12z?uid=723286a1924ee2143c9a5e8f&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl',NULL),(201,'子健体育俱乐部',0,'18846922264','1219116968@qq.com','北京','北京','2023-09-25 01:29:02');
...
CREATE TABLE `resources` (
                             ...
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=166 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='资源表元数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sport_category` (
                                  ...
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='体育类别表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wechat` (
                          ...
                          `create_time` datetime DEFAULT NULL COMMENT '授权时间',
                          PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='小程序表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wechat` VALUES (1,'wxc62afc144417346e','2387d60cc0a34703ae8ec0acedd2a635','po80bb43-4a86-463e-8a64-86af145af212','乐刻小程序',1,0,'润迪开通的小助手','2023-09-25 01:31:21'),(2,'wxc62afc1444173555','b5a7ea8dcee900d1f1663076ac8dba3b','4180bb43-4a86-463e-8a64-86af145af2op','王子健小程序',3,1,'备注','2023-07-28 11:31:30'),(3,'wxc62afc1444173999','b5a7ea8dcee900d1f1663076ac8dba3b','8180bb43-4a86-463e-8a64-86af145af2gf','哈尔滨2小程序',16,1,'123','2023-09-07 01:07:02'),(4,'wxc62afc1444173888','b5a7ea8dcee900d1f1663076ac8dba3b','3180bb43-4a86-463e-8a64-86af145af245','润迪专属小程序',2,1,NULL,'2023-08-14 07:34:45'),(6,'wxc62afc1444173776','1111111111111111111111111111','2180bb43-4a86-463e-8a64-86af145af27e','润迪小程序',2,0,'润迪小程序','2023-09-24 20:49:39'),(8,'12345','123456','c843f0b1-38b6-4da6-b340-15814ed63aea','子健健身小程序',201,1,NULL,'2023-09-25 01:31:44');
...
CREATE TABLE `wx_report_data` (
                                  ...
                                  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='微信用户数据上报表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-25  9:46:37
