...
CREATE TABLE `developer_review` (
                                    ...
                                    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                                    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='开发者审核表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `developer_review` VALUES (1,'王子健提交的算法',6,0,'篮球','3d5a1466-51dc-4da7-ab9f-01eaae60a568','1234',0,'算法运行失败','2023-07-31 20:43:54'),(2,'王子健提交的算法2',12,2,'网球','3d5a1466-51dc-4da7-ab9f-01eaae60a568','1234',1,'备注','2023-08-03 22:09:54'),(3,'开发者提交审核',21,1,'田径','uuid','123',0,'wangzijian','2023-08-20 00:16:03'),(14,'王子健提交的算法',13,0,'足球','uuid','demo',0,'备注','2023-08-20 00:27:26'),(15,'开发者13',13,0,'电竞','uuid','demo',0,'备注','2023-08-20 16:46:36'),(16,'算法文件2',12,0,'排球','uuaslkjdlaskjdlak','string',0,'备注','2023-08-20 17:10:39'),(17,'算法文件2',13,0,'排球','618a847f-58e0-475f-93b2-4625f20bc185','string',0,'备注','2023-08-20 17:10:39');
...
CREATE TABLE `resources` (
                             ...
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='资源表元数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `session` VALUES ('b9b6ed64-4adc-4806-850e-d20e47d66e80',13,'127.0.0.1','2023-08-20 22:27:11'),('8c638c8e-a5e0-43eb-8e56-820f1093eb5d',13,'169.254.35.13','2023-08-20 22:45:15');
...
-- Dump completed on 2023-08-20 23:12:47
