...
public class SwaggerConfig {
    ...
    public Docket createManagementRestApi() {
        return new Docket(DocumentationType.OAS_30) // v2 不同
                ...
                .apiInfo(Management())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.zlht.pbr.algorithm.management.api.management.controller")) // 设置扫描路径
                .build();
    }
    ...
    public Docket createDeveloperRestApi() {
        return new Docket(DocumentationType.OAS_30) // v2 不同
                ...
                .apiInfo(Developer())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.zlht.pbr.algorithm.management.api.developer.controller")) // 设置扫描路径
                .build();
    }
